...
const ProductPage =()=> (
  ...
  <div style={{backgroundColor:'#D2F4FD',width:'100%'}}>
    ...
    <ProductContent id = {0} name={newnavi} release="2016/2/4 " contentTitle={<p style={{fontSize:'2.2vw',fontFamily:'ヒラギノ角ゴ Pro'}}>新入生Navi<br></br></p>}
    ...
    <ProductContent id= {1} name={music} release="2018/11/02 " contentTitle={<p style={{fontSize:'2.2vw',fontFamily:'ヒラギノ角ゴ Pro'}}>音楽リズムゲーム♫<br></br></p>}
     description={<p style={{fontSize:'1.8vw',fontFamily:'ヒラギノ角ゴ Pro'}}>音楽に合わせて画面をタッチ、得点を競おう</p>}/>

   <ProductContent id= {0} name={vr} release="2016/11/04 " contentTitle={<p style={{fontSize:'2.2vw',fontFamily:'ヒラギノ角ゴ Pro'}}>スクリーンゲーム<br></br><br></br>VRアドベンチャー！</p>}
          description={<p style={{fontSize:'1.8vw',fontFamily:'ヒラギノ角ゴ Pro'}}>弾を使って恐竜を倒すVRゲーム</p>}/>

        <ProductContent id = {1} name={torokko} contentTitle={<p style={{fontSize:'2.2vw',fontFamily:'ヒラギノ角ゴ Pro'}}>スクリーンゲーム<br></br><br></br>トロッコクイズ</p>}
          description={<p style={{fontSize:'1.8vw',fontFamily:'ヒラギノ角ゴ Pro'}}>トロッコに乗って２択クイズを解こう</p>}/>
        <ProductContent id = {0} name={balloon}  contentTitle={<p style={{fontSize:'2.2vw',fontFamily:'ヒラギノ角ゴ Pro'}}>スクリーンゲーム<br></br><br></br>風船パーセント</p>}
