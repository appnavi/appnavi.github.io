...
{(matches) => {
  if(matches){
    return(
      ...
      <h1 style={{color:'white',fontSize:'4.0vw',textAlign:'center',backgroundColor:'#D2F4FD',margin:0,paddingTop:'5.0vw',paddingBottom:'4.0vw'}}>News</h1>
        <div style={{width:'90%',height:'100vw',margin:'0 auto',display:'flex'}}>
            ...
            <div>
              <p style={{fontSize:'2.4vw'}}>アットホームな雰囲気で和気あいあいと活動中！(^ ^)</p>
              <p style={{fontSize:'2.4vw'}}>未経験も女子も大歓迎です！</p>
              <div>
